...
namespace Ataw.RightCloud.Web
{
    ...
    public class AuthController : AtawBaseController
    {
        ...
        [RightFilter]
        public ActionResult Home(string x, string h, string t, string r, string f, string d)
        {
            string _homePage = "HomeUrl".AppKv<string>("$FEED$");
            ViewBag.IsDev = !d.IsAkEmpty() || "IsDev".AppKv<bool>(false);
            ViewBag.IsSkin = "IsSkin".AppKv<bool>(false);
        ...
        public ActionResult Front(string x, string h, string t, string r, string f, string d)
        {
            return this.Home(x, h, t, r, f, d);
        }

        // GET: Auth
        public ActionResult Index(string id,string wxCode)
        {
            ...
            {
                return View("~\\Areas\\RightCloud\\Views\\Auth\\WxCode.cshtml");
            }
        ...
        public ActionResult WxBing(string userName, string orgId)
        {
            ViewBag.userName = userName;
            ViewBag.orgId = orgId;
            UserService userService = new UserService();
            var userData = userService.GetUser(orgId);
            ViewBag.userData = userData;
            return View();
        }
        public ActionResult BingSuccess()
        {
            return View();
        }
        public ActionResult BingFail()
        {
            return View();
        }
        public ActionResult WxError()
        {
            return View();
        }
    }
